                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} required
                            className="mt-1 h-14 block w-full text-xl rounded-md border-gray-300 shadow-lg focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" id="price" value={price} onChange={(e) => setPrice(e.target.value)} required step="0.01" min="0"
                            className="mt-1 h-14 block w-full rounded-md border-gray-300 shadow-lg focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
                    </div>
                    <button
                        type="submit"
